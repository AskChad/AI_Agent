      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { name: 'get_contact_details', calls: 145, success: 98 },
                { name: 'create_opportunity', calls: 89, success: 95 },
                { name: 'send_ghl_message', calls: 234, success: 99 },
                { name: 'update_contact_tag', calls: 67, success: 100 },
                { name: 'check_inventory', calls: 42, success: 92 },
              ].map((func, i) => (

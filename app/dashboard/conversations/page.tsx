    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-800 mt-1">View and manage customer conversations</p>
        </div>
        <Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-gray-800">Total Conversations</p>
        ...
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-gray-800">Total Messages</p>
      ...
      {filteredConversations.length === 0 && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-800">Try adjusting your search or filters</p>
          </CardContent>
        </Card>
      )}
    </div>
